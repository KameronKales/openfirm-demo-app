...
var ApiClient = /*#__PURE__*/ (function () {
  ...
  function ApiClient() {
     ...
     * The base URL against which to resolve every API call's (relative) path.
     * @type {String}
     * @default https://www.openfirm.co/api
     */
      ...
      },
      {
        ...
        value: function callApi(
          ...
          request
            ...
            .set(this.normalizeParams(headerParams)); // set requestAgent if it is set by user
          ...
          if (contentType === "application/x-www-form-urlencoded") {
            request.send(
              _querystring["default"].stringify(
